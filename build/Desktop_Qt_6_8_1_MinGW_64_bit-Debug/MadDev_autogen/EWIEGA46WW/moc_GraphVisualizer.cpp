...
static constexpr auto qt_meta_stringdata_ZN15GraphVisualizerE = QtMocHelpers::stringData(
    "GraphVisualizer"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN15GraphVisualizerE[] = {
...
Q_CONSTINIT const QMetaObject GraphVisualizer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15GraphVisualizerE.offsetsAndSizes,
    qt_meta_data_ZN15GraphVisualizerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15GraphVisualizerE_t,
        // Q_OBJECT / Q_GADGET
...
void *GraphVisualizer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15GraphVisualizerE.stringdata0))
